...
public class BoardController {
	...
	@RequestMapping("/saveBoard") // saveBoard 요청이 불려졌을 때 요청을 받아서
	public String saveBoard(BoardVO vo){
		logger.info("[BoardController - saveBoard] 요청");	
		
		service.saveBoard(vo); // saveBoard 함수를 하나 부를거야
	...
	@RequestMapping("/updateBoard") // saveBoard 요청이 불려졌을 때 요청을 받아서
	public String updateBoard(BoardVO vo){
		logger.info("[BoardController - updateBoard] 요청");	
		
		service.updateBoard(vo); // saveBoard 함수를 하나 부를거야
